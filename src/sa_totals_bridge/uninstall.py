...
def prompt_uninstall_config() -> BridgeUninstallConfig:
    runtime_dir = Path(
        prompt_text(
...
def validate_uninstall_config(uninstall_config: BridgeUninstallConfig) -> None:
...
def execute_uninstall(uninstall_config: BridgeUninstallConfig) -> None:
...
def remove_service(uninstall_config: BridgeUninstallConfig) -> None:
...
def print_summary(uninstall_config: BridgeUninstallConfig) -> None:
    print("")
    print("Desinstalacion del bridge completada.")
    if uninstall_config.remove_service:
